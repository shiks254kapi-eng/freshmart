...
import { ShoppingCart, TrendingUp, AlertTriangle, Star, Package } from 'lucide-react'
...
export default function Dashboard() {
    ...
    return ( <
        ...
        <
        div className = "stat-label flex gap-8" > < ShoppingCart size = { 14 }
        /> Total Orders</div >
        <
        ...
        div className = "card-header" >
        <
        div className = "card-title" > < ShoppingCart size = { 16 }
        /> Recent Orders</div >
        <
        ...
        div className = "card" >
        <
        div className = "card-header" > < div className = "card-title" > < Package size = { 16 }
